...
void EmptyLinkFunctionForGeneratedCodeThisIsFine_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_ThisIsFine()
	{
		if (!Z_Registration_Info_UPackage__Script_ThisIsFine.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				...
				(UObject* (*)())Z_Construct_UDelegateFunction_ThisIsFine_OnStartLevelFinished__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_ThisIsFine(Z_Construct_UPackage__Script_ThisIsFine, TEXT("/Script/ThisIsFine"), Z_Registration_Info_UPackage__Script_ThisIsFine, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x1B6F5AC2, 0xCFD71B70));
